...
public class StreamRestController {
	...
	public ModelAndView startStream(@ModelAttribute("spon") Spon spon,HttpSession session) throws Exception{
...
return modelAndView;
	...
	ModelAndView view = new ModelAndView("redirect:192.168.0.12:3000/streamer="+user.getUserNo()+"&userName="+user.getUserNickname());
	return view;	
	}
