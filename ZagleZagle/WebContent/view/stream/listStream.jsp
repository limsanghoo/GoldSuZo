...
$(function() {
	...
	$('a[name="get"]').on("click", function() {
		...
		alert(streamer);
		  window.open("https://192.168.0.12:443/stream/last2?streamer="+streamer+"&userNo=US10002&userNickname=user02&userProfile=default.jpg", "popup_window", "width=1450, height=900, scrollbars=no");
	}); 
