				...
				<td align="left">
					...
					<c:if test="${buy.sellProd.sellStyle=='10'}">
						...
						<c:if test="${buy.sellProd.sellState=='60'}">
							<a href="/trade/searchTracking?buyNo=${buy.buyNo}" onclick="window.open(this.href,'','width=1230, height=700, scrollbars=yes'); return false;" href="/trade/searchTracking?buyNo=${buy.buyNo}">배송조회</a>
							&emsp;ㅣ&emsp;
